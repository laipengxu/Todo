package com.roc.todo.widget.ItemDecoration;
...
public class NormalDividerDecoration extends RecyclerView.ItemDecoration {
  ...
  public NormalDividerDecoration(Context context) {
  ...
  private int getOrientation(RecyclerView parent) {
    ...
    try {
      ...
      throw new IllegalStateException("NormalDividerDecoration can only be used with a " +
