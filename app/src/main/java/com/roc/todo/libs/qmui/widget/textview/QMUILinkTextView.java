package com.roc.todo.libs.qmui.widget.textview;
...
import com.roc.todo.libs.qmui.link.QMUILinkify;
import com.roc.todo.R;
import com.roc.todo.libs.qmui.link.QMUILinkTouchMovementMethod;
import com.roc.todo.libs.qmui.span.QMUIOnSpanClickListener;

import java.util.HashSet;
import java.util.Set;

/**
 * 使 {@link TextView} 能自动识别 URL、电话、邮箱地址。
 * 相比于 {@link TextView} 使用 {@link android.text.util.Linkify},
 * {@link QMUILinkTextView} 有以下特点:
 * <ul>
 * <li>可以通过 {@link com.roc.todo.R.styleable#QMUILinkTextView} 中的属性设置链接的样式</li>
